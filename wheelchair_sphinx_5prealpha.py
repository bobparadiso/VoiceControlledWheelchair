...
proc = subprocess.Popen(['sh', '-c', "script -q -c 'pocketsphinx_continuous -inmic yes -adcdev " + adcdev + " -samprate 16000/8000/48000 -lm ~/languageModel/" + languageModel + ".lm -dict ~/languageModel/" + languageModel + ".dic -vad_postspeech 10 -vad_prespeech 10 2>/dev/null'"],stdout=subprocess.PIPE)
